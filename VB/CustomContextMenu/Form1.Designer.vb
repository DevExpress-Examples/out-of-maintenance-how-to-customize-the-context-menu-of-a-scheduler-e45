...
Namespace CustomContextMenu
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.schedulerControl1.Size = New System.Drawing.Size(468, 415)
			Me.schedulerControl1.Start = New System.DateTime(2008, 10, 1, 0, 0, 0, 0)
			Me.schedulerControl1.Storage = Me.schedulerStorage1
			Me.schedulerControl1.TabIndex = 0
			Me.schedulerControl1.Text = "schedulerControl1"
			Me.schedulerControl1.Views.DayView.TimeRulers.Add(timeRuler1)
			Me.schedulerControl1.Views.WorkWeekView.TimeRulers.Add(timeRuler2)
'			Me.schedulerControl1.PreparePopupMenu += New DevExpress.XtraScheduler.PreparePopupMenuEventHandler(Me.OnPreparePopupMenu);
'			Me.schedulerControl1.EditAppointmentFormShowing += New DevExpress.XtraScheduler.AppointmentFormEventHandler(Me.schedulerControl1_EditAppointmentFormShowing);
			...
			' schedulerStorage1
			' 
'			Me.schedulerStorage1.AppointmentsDeleted += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.schedulerStorage_AppointmentsChanged);
'			Me.schedulerStorage1.AppointmentsInserted += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.schedulerStorage_AppointmentsChanged);
'			Me.schedulerStorage1.AppointmentsChanged += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.schedulerStorage_AppointmentsChanged);
			' 
			' dateNavigator1
			' 
			...
			Me.splitterControl1.Location = New System.Drawing.Point(468, 0)
			Me.splitterControl1.Name = "splitterControl1"
			Me.splitterControl1.Size = New System.Drawing.Size(6, 415)
			...
			Me.Name = "Form1"
			Me.Text = "Custom Edit Appointment Form Demo"
