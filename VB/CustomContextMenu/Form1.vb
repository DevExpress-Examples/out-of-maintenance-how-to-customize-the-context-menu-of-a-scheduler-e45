...
Namespace CustomContextMenu
	Partial Public Class Form1
		...
		Private Shared Sub FillStorageCollection(ByVal c As PersistentObjectCollection, ByVal fileName As String)
		...
		Private Sub schedulerStorage_AppointmentsChanged(ByVal sender As Object, ByVal e As PersistentObjectsEventArgs) Handles schedulerStorage1.AppointmentsDeleted, schedulerStorage1.AppointmentsInserted, schedulerStorage1.AppointmentsChanged
			schedulerStorage1.Appointments.Items.WriteXml(aptDataFileName)
		End Sub

		Private Sub OnPreparePopupMenu(ByVal sender As Object, ByVal e As PreparePopupMenuEventArgs) Handles schedulerControl1.PreparePopupMenu
		...
		Private Sub schedulerControl1_EditAppointmentFormShowing(ByVal sender As Object, ByVal e As AppointmentFormEventArgs) Handles schedulerControl1.EditAppointmentFormShowing
			...
			If (CType(sender, SchedulerControl)).Storage.Appointments.IsNewAppointment(e.Appointment) Then
